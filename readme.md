...
> **Note**: This is a maintained fork of [coddingtonbear/paprika-recipes](https://github.com/coddingtonbear/paprika-recipes), updated to work with Python 3.11+ and current Paprika API changes. Maintenance is assisted by LLM (Claude) - not yet suitable for wide usage. Use at your own risk.
...
- **Unofficial API**: This tool uses Paprika's reverse-engineered API, not an official one
...
```bash
# Clone and install
git clone https://github.com/tieguy/paprika-recipes.git
cd paprika-recipes
uv sync
...
```bash
pip install git+https://github.com/tieguy/paprika-recipes.git
```
